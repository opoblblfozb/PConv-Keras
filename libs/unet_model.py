...
class UNetModel(Model):
    ...
    def __init__(self, img_rows=512, img_cols=512, *args, **kwargs):
    ...
    def train_step(self, data):
        ...
        with tf.GradientTape() as tape:
            ...
            for o, g in zip(vgg_comp, vgg_gt):
                l5 += 120 * l1_error(gram_matrix(o), gram_matrix(g)) * 0.0005
